...
#
# Generated by export_simulation on Sat Jul 11 03:28:45 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './data_ram_0.sh' script.

./data_ram_0.sh -reset_run
...
./data_ram_0.sh -noclean_files

For more information on the script, please type './data_ram_0.sh -help'.
